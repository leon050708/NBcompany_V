  ...
  <div class="company-overview">
    ...
    <div class="welcome-section">
      <div class="welcome-content">
        <div class="welcome-text">
          ...
          <p class="welcome-subtitle">{{ companyName }} · 今天是 {{ currentDate }}，祝您工作愉快！</p>
        </div>
    ...
    <div class="actions-section">
      ...
      <div class="actions-grid">
        ...
        <div class="action-card" @click="$emit('navigate', 'meetings/list')">
          <div class="action-icon">
    ...
    <div class="status-section">
      <h2 class="section-title">企业状态</h2>
      <div class="status-grid">
        <div class="status-card">
          <div class="status-header">
            <el-icon class="status-icon online"><CircleCheck /></el-icon>
            <span class="status-text">企业运行正常</span>
          </div>
        ...
        <div class="status-card">
          <div class="status-header">
            ...
            <span class="status-text">今日动态</span>
          </div>
          <div class="status-details">
            <div class="status-item">
              <span>新增员工</span>
...
import { 
  UserFilled, User, OfficeBuilding, TrendCharts, CircleCheck,
